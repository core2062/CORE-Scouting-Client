...
# TODO: rewrite templator, cut out bloat, strip down to core (input text > output html)... no file manipulation and no caching
# finish cutting out all web.py related stuff and seperate core of templator

"""
templator: simple, elegant templating
from web.py
