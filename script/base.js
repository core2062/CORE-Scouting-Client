...
(function($){
    ...
    // automatically resize the control
		...
		if( $.browser.msie ){
			...
			$input.bind("click.toggle", function (){ $input.triggerHandler("change.toggle"); });
		}
	...
	var defaults = {
		...
		, classHandleMiddle: "toggle-handle-middle"
		, classHandleRight:  "toggle-handle-right"
		, classHandleActive: "toggle-active-handle"
		, classPaddingLeft:  "toggle-padding-left"
		, classPaddingRight: "toggle-padding-right"
